...
void insert_at_position(int value, int position) {
    ...
    // Insert at the specified position or at the end if the position exceeds the list size
    if (currentPosition == position) {
        newNode->next = current;
        previous->next = newNode;
        cout << "Inserted " << value << " at position " << position << "." << endl;
    } else {
        cout << "Position exceeds the size of the linked list. Inserting at the end." << endl;
        insert_at_end(value);
    }
}
